...
package com.nari.rt21dms.qrcodelib.zxing.camera;
...
public final class CameraManager {
    ...
    public static  int MIN_FRAME_WIDTH = 600;//改进扫描框的最小宽度
    public static  int MIN_FRAME_HEIGHT = 100;//改进扫描框的最小高度
    public static  int MAX_FRAME_WIDTH = 800;//改进扫描框的最大宽度
    public static  int MAX_FRAME_HEIGHT = 300; // = 5/8 * 1080 //改进扫描框的最大高度
    ...
    public Rect getFramingRect(int offsetX, int offsetY) {
        ...
        if (framingRect == null) {
            ...
            System.out.println("--------width------------"+MIN_FRAME_WIDTH);
